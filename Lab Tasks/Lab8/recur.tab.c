...
#line 13 "recur.y"
                  {printf("Result: %d\n",yyvsp[0]);}
#line 1075 "recur.tab.c"
    break;

  case 4: /* expression: expression '+' term  */
#line 16 "recur.y"
                                { yyval = yyvsp[-2] + yyvsp[0]; }
#line 1081 "recur.tab.c"
    break;

  case 5: /* expression: expression '-' term  */
#line 17 "recur.y"
                                { yyval = yyvsp[-2] - yyvsp[0]; }
#line 1087 "recur.tab.c"
    break;

  case 7: /* term: term '*' factor  */
#line 21 "recur.y"
                      { yyval = yyvsp[-2] * yyvsp[0]; }
#line 1093 "recur.tab.c"
    break;

  case 8: /* term: term '/' factor  */
#line 22 "recur.y"
                      { yyval = yyvsp[-2] / yyvsp[0]; }
#line 1099 "recur.tab.c"
    break;

  case 9: /* factor: NUMBER  */
#line 25 "recur.y"
                       { yyval = yyvsp[0]; }
#line 1105 "recur.tab.c"
    break;

  case 10: /* factor: '(' expression ')'  */
#line 26 "recur.y"
                           { yyval = yyvsp[-1]; }
#line 1111 "recur.tab.c"
    break;


#line 1115 "recur.tab.c"

...
YY_RULE_SETUP
#line 9 "calc1.l"
{ yylval = atoi(yytext); return NUMBER; } // Convert matched string to integer
	YY_BREAK
case 2:
YY_RULE_SETUP
#line 10 "calc1.l"
{ /* Do something appropriate here */ return ALPHA; } // You might want to change this to return LETTER or something appropriate
	YY_BREAK
case 3:
YY_RULE_SETUP
#line 11 "calc1.l"
